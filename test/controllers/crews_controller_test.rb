...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference('Crew.count') do
      post crews_url, params: { crew: { group_id: @crew.group_id, integrantes: @crew.integrantes } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { group_id: @crew.group_id, integrantes: @crew.integrantes } }
